...
const knowledgeBase = {
  en: {
    ...
    "presskit": "Need a DJ press kit? Wilfredo designs digital press kits for artists. Click the \"Quote\" button to request one.",
  ...
  es: {
    ...
    "presskit": "¿Necesitas un press kit de DJ? Wilfredo diseña press kits digitales para artistas. Haz clic en el botón \"Cotizar\" para solicitarlo.",
    ...
    "vale": "Cada proyecto es único, así que no puedo darte una cifra exacta aquí. Haz clic en el botón flotante \"Cotizar\" para contarnos los detalles, o agenda una llamada en Calendly para hablar directamente.",
